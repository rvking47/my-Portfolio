...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
     ...
     A collection of full stack web development projects showcasing dynamic front-end interfaces and robust back-end integration.</motion.p>
        ...
        {workData.map((project, index)=>(
            ...
            style={{backgroundImage: `url(${project.bgImage})`}}>
                <div className='bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7'>
                    <div>
                        <a href={project.link} target='_blank' ><h2 className='font-semibold'>{project.title}</h2>
